...
#SBATCH --error=error_final_clean_finetune_4.log
...
python ./run.py --config_path ./config/final/final_clean_finetune_4.yaml --mode train --result_path ./result/final_clean/ || true
