...
python ./run.py --config_path ./config/final/final_multi_regular_lora_33_3.yaml --resume_path ./result/final_multi/20241204-17-14-22/checkpoint/model_supcon.pth --mode train --result_path ./result/final_multi/ || true
