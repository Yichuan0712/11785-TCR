...
#SBATCH --error=error_final_clean_lora_33.log
...
python ./run.py --config_path ./config/final/final_clean_lora_33.yaml --mode train --result_path ./result/final_clean/ || true
