...
#SBATCH --error=error_final_clean.log
#SBATCH --output=output_final_clean.log
...
python ./run.py --config_path ./config/final/final_clean.yaml --mode train --result_path ./result/final_clean/ || true
